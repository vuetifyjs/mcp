...
- Windows launcher no longer breaks on spaces in Node path (#46)
- npm/npx POSIX bin symlinks correctly invoke main() via realpath guard (#46)
...
[0.12.1]: https://github.com/vuetifyjs/mcp/compare/v0.12.0...v0.12.1
